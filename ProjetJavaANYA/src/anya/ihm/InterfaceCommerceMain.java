...
public class ManualTest {
    public static void main(String[] args) {
        ...
        PoubelleIntelligente poubelle = new PoubelleIntelligente(48.90058, 2.07033, centreDeTri, "Poubelle dans la rue");
        ...
        try {
            ...
            if (!propositions.isEmpty()) {
                ...
                supermarche.accepter(propositions.get(0), LocalDate.now().plusDays(5), "Electromenager");
