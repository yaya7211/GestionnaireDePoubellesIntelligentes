...
public class BonAchat {
	...
	public boolean utiliser() {
		if (this.estValide() & this.etat == EtatBonAchat.RECLAME) {
	...
	public String toString() {
	    return "Montant : " + this.montant +
	           " | Points requis : " + this.pointsRequis +
	           " | Magasin : " + (this.commerceMere != null ? this.commerceMere.getNom() : "Non spécifié") +
	           " | Catégorie produit : " + this.categorieProduits +
